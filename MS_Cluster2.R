...
#save.image("~/Ms.RData")
ms.combined[["plp"]] <- PercentageFeatureSet(ms.combined, pattern = "^PLP1-")
VlnPlot(ms.combined, features = c("plp", "nCount_RNA", "percent.mt"), ncol = 3)
...
FeaturePlot(ms.combined, features = c("ACAA1", "ACOT1", "ACOT2"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("ACOT4", "ACOT7", "ACOX1"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("ACOX3", "BAAT", "ELOVL2"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("ELOVL5", "ELOVL6", "FADS1"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("FADS2", "HACD1", "HACD2"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("HACD3", "HACD4", "HADHA"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("HSD17B12", "PECR", "SCD"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("SCD5", "TECR"), min.cutoff = "q9", split.by = "stim")

FeaturePlot(ms.combined, features = c("ACAA1", "ACADL", "ACADM"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("ACOX1", "ACOX2", "ACOX3"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("ACSBG1", "ACSBG2", "ACSL1"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("ACSL3", "ACSL4", "ACSL5"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("ACSL6", "ADIPOQ", "ANGPTL4"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("APOA1", "APOA2", "APOA5"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("APOC3", "AQP7", "CD36"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("CPT1A", "CPT1B", "CPT1C"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("CPT2", "CYP27A1", "CYP7A1"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("CYP8B1", "DBI", "EHHADH"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("FABP1", "FABP2", "FABP3"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("FABP4", "FABP5", "FABP6"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("FABP7", "FADS2", "GK"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("GK2", "HMGCS2", "ILK"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("LPL", "ME1", "MMP1"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("NR1H3", "OLR1", "PCK1"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("PCK2", "PDPK1", "PLIN1"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("PLIN2", "PLIN4", "PLIN5"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("PLTP", "PPARA", "PPARD"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("PPARG", "RXRA", "RXRB"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("RXRG", "SCD", "SCD5"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("SCP2", "SLC27A1", "SLC27A2"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("SLC27A4", "SLC27A5", "SLC27A6"), min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("SORBS1", "UBC", "UCP1") min.cutoff = "q9", split.by = "stim")
FeaturePlot(ms.combined, features = c("PLP1"), min.cutoff = "q9")
